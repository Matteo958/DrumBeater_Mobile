...
public class NoteInfo
{
    ...
    [Range(1, 4)] public int removerID = 1;
    //[Tooltip("The hit raw of the note, starting from the top")]
    //[Range(1, 3)] public int raw = 1;
    [Tooltip("Defines if this note counts for the endgame special move")]
